...
from logic.logic_scanner.obras.logic_obrasSACEM import scanner

class ScannerObrasSACEM(ttk.Frame):
    def __init__(self, master, **kwargs):
        ...
        ttk.Label(frm, text="Carpeta obras SACEM: ").grid(row=0, column=0, sticky="e", padx=5, pady=5)
        ...
        self.tooltip = ImageTooltip(
            self.btn_help,
            image_path=resource_path("assets", "info_obras", "sacem", "img2.png"),
