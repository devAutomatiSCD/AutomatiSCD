...
from logic.logic_scanner.obras.logic_obrasMESAM import scanner_excel

class ScannerObrasMESAM(ttk.Frame):
    def __init__(self, master, **kwargs):
        ...
        ttk.Label(frm, text="Carpeta obras MESAM: ").grid(row=0, column=0, sticky="e", padx=5, pady=5)
        ...
        self.tooltip = ImageTooltip(
            self.btn_help,
            image_path=resource_path("assets", "info_obras", "mesam", "img1.png"),
            text="Los Excel en la carpeta deben contener esta estructura\n para que se pueda procesar"
        )
    ...
    def scanner(self):
        ...
        def worker():
            res = scanner_excel(ruta_boletines, folio, stop_event=self.stop_event)
