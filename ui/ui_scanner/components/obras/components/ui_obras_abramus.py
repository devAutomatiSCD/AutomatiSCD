...
class ScannerObrasABRAMUS(ttk.Frame):
    def __init__(self, master, **kwargs):
        ...
        ttk.Label(frm, text="Archivo obras ABRAMUS (.pdf): ").grid(row=0, column=0, sticky="e", padx=5, pady=5)
        ...
        self.tooltip = ImageTooltip(
            self.btn_help,
            image_path_getter=resource_path("assets", "info_obras", "abramus", "img1.png"),
