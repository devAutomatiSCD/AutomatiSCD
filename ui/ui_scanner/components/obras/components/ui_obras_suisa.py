...
from logic.logic_scanner.obras.logic_obrasSUISA import scanner

class ScannerObrasSUISA(ttk.Frame):
    def __init__(self, master, **kwargs):
        ...
        ttk.Label(frm, text="Archivo obras SUISA (.pdf): ").grid(row=0, column=0, sticky="e", padx=5, pady=5)
